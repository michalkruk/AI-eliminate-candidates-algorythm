#Importowanie danych, które są przekazywane do drzewa decyzyjnego
import csv
...
dataset=[(('brak','sa','gasnie'),'Y'),(('zapada_sie','sa','dobrze'),'Y'),(('dobrze','sa','gasnie'),'N'),(('zapada_sie','sa','dobrze'),'Y')]
attributes =('grob','kwiaty','pochodnia')


f = Holder(attributes)
f.add_values('grob',('brak','zapada_sie','dobrze')) #wartosci jakie moze przyjac grob
f.add_values('kwiaty',('nie_ma','sa')) #wartosci jakie moga przyjac kwiaty
f.add_values('pochodnia',('nie_ma','gasnie','dobrze')) #wartosci dla pochodni
